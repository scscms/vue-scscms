<template>
  <div class="scs-screen login">
    ...
    <el-dialog :title="title[type]" :visible.sync="register.visible">
      <el-form :model="form" :rules="register.rules" label-width="80px" ref="regForm">
        ...
        <el-form-item label="确认密码" prop="pass_words">
          <el-input type="password" v-model="form.pass_words" @keyup.native.enter="registers"
                    :placeholder="placeholder.pass"></el-input>
        </el-form-item>
      </el-form>
