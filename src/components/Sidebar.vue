    ...
    <div :class="[sidebar,slide_class]">
        <div class="sidebar_div">
            <div class="el-message-box__header">
                <div class="el-message-box__title"><slot name='title'></slot></div>
                <i class="el-message-box__close el-icon-close" @click="close"></i>
            </div>
            <slot name='content'><div class="sidebar_content"></div></slot>
            <slot name='foot'><div class="sidebar_foot"></div></slot>
        </div>
...
<style lang="less">
    ...
    .slide_out .sidebar_div{animation-name: slide_out;}
    @keyframes slideIn {
    ...
    .slide_in .sidebar_bg{animation-name: opacity_in}
    .slide_out .sidebar_bg{animation-name: opacity_out}
